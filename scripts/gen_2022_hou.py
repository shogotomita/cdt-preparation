    ...
    q(
        ...
        [
            (
                "A",
                "a,d",
                "不正解。a(契約申込の年月日及び契約の成立に関する事項)は企画旅行の契約書面の記載事項ではなく、説明書面側の事項である。",
            ),
            (
                "B",
                "b,c",
                "不正解。b・cは正しいが、d(最少催行人員)も契約書面の記載事項であり抜けている。",
            ),
            (
                "C",
                "b,c,d",
                "正解。b(責任・免責)、c(対価に含まれない通常必要経費)、d(最少催行人員)は契約書面の記載事項。aは該当しない。",
            ),
            (
                "D",
                "a,b,c,d",
                "不正解。a(契約申込の年月日及び契約の成立に関する事項)は企画旅行の契約書面の記載事項として定められていない。",
            ),
        ],
    ...
    q(
        ...
        [
            (
                "A",
                "a,d",
                "正解。a(管理者は請求時に提示)とd(外務員は請求の有無にかかわらず提示)が正しい。bは役員も外務員に含まれ得ること、cは証明書の発行主体が知事ではないことが誤り。",
            ),
            (
                "B",
                "b,c",
            ...
            (
                "C",
                "a,c,d",
                "不正解。c(知事が発行)が誤り。外務員証明書は旅行業者等が作成・交付する。",
            ),
            (
                "D",
                "a,b,c,d",
    ...
    q(
        ...
        [
            (
                "A",
                "a,b",
                "不正解。a・bは正しいが、dも正しく、cのみが誤り。a,bだけでは不足。",
            ),
            (
                "B",
                "a,c",
                "不正解。cは誤り(違法サービスのあっせん広告も禁止)。b・dが抜け、cを含んでいる。",
            ),
            (
                "C",
                "b,d",
                "不正解。b・dは正しいが、aも正しく抜けている。",
            ),
            (
                "D",
                "a,b,d",
                "正解。a(従業者の強要禁止)、b(名義貸し禁止)、d(不実告知等の禁止)が正しい。cは便宜供与がなくてもあっせん広告自体が禁止され得るため誤り。",
            ),
        ],
        "【禁止行為・名義利用等】\n- 特定サービス受領の強要(従業者も対象)\n- 重要な事項の不実告知・故意の不告知\n- 法令違反サービスのあっせん・その広告等\n- 名義貸し・営業の貸渡しによる他人名義経営の禁止\n\n【選択肢との対応】\n- エ:a,b,d → 正解\n- c:「便宜を供与しなければ広告はセーフ」は誤り\n\n【学習メモ】\n組合せ問題は誤肢(c)を含む組を落とし、正しい肢だけの組を選ぶ。",
        ["D"],
    ),
    q(
        21,
    ...
    q(
        ...
        [
            (
                "A",
                "a,b",
                "不正解。aは誤り(地域限定も所属旅行業者にできる)。bの「いかなる場合であっても」も言い過ぎで誤り。",
            ),
            (
                "B",
                "c,d",
                "正解。c(原則として所属以外のために取り扱えない/受託旅行業者代理業者の例外)とd(誤認表示の禁止)が正しい。",
            ),
            (
                "C",
                "a,b,c",
