    ...
    q(
        ...
        [
            (
                "A",
                "a,b",
                "不正解。a(手配のみ)とb(国内で代行不可)はいずれも誤り。",
            ),
            (
                "B",
                "c,d",
                "正解。c(通信契約以外は申込書+申込金)とd(申込金は代金・取消料・違約料の一部)が正しい。",
            ),
            (
                "C",
                "b,c,d",
                "不正解。b(国内では手配代行できない)が誤り。国内でも手配代行者に代行させ得る。",
            ),
            (
                "D",
                "a,b,c,d",
    ...
    q(
        ...
        [
            (
                "A",
                "a,c",
                "不正解。a(いかなる場合も事前説明)とc(過剰予約による増額)はいずれも誤り。",
            ),
            (
                "B",
                "b,d",
                "正解。b(地位譲渡の手続・手数料)とd(権利義務の承継)が正しい。",
            ),
            (
                "C",
                "b,c,d",
                "不正解。cが誤り。過剰予約による宿泊費用増では旅行代金を増額できない。",
            ),
            (
                "D",
                "a,b,c,d",
    ...
    q(
        ...
        [
            (
                "A",
                "a,d",
                "正解。a(企画料金明示時の21日目より前解除→企画料金相当の取消料)とd(申込金なしの団体は当該書面交付時に成立)が正しい。",
            ),
            (
                "B",
                "b,c",
                "不正解。b(増額分を業者負担)とc(企画書面で契約書面に代える)はいずれも誤り。",
            ),
            (
                "C",
                "a,b,d",
                "不正解。bが誤り。費用増額分は旅行者の負担である。",
            ),
            (
                "D",
                "a,b,c,d",
    ...
    q(
        ...
        [
            (
                "A",
                "a,c",
                "不正解。a(レンタカー事故の入院)とc(スノーボード通院)は支払いの対象となる。対象外はb・d。",
            ),
            (
                "B",
                "b,d",
                "正解。b(コンタクトレンズの紛失)とd(原動機付自転車の盗難)は対象外。a・cは対象。",
            ),
            (
                "C",
                "a,b,d",
                "不正解。aは入院見舞金の対象となるため、対象外のみの組ではない。",
            ),
            (
                "D",
                "a,b,c,d",
