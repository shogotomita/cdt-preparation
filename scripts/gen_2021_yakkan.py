    ...
    q(
        ...
        [
            (
                "A",
                "a,b",
                "不正解。aは約款に定める重要な変更(宿泊機関の変更)に該当し、旅行者は取消料なしで解除できる。取消料を要するものではない。",
            ),
            (
                "B",
                "a,c",
                "不正解。aは重要変更に該当し取消料不要。cは国内旅行の直行便→乗継便の変更であり、約款上の重要な変更には当たらず取消料を要するが、aを含む組は誤り。",
            ),
            (
                "C",
                "b,c",
                "正解。bは自己都合(疾病)による解除で取消料を要する。cは国内旅行における直行便から乗継便への変更で、約款上の重要な変更に該当せず取消料を要する。",
            ),
            (
                "D",
                "a,b,c",
                "不正解。aは重要変更に該当し取消料不要のため、取消料を要するものには含まれない。",
            ),
        ],
        "【制度】\n旅行開始前の旅行者解除と取消料。\n"
    ...
    q(
        ...
        [
            (
                "A",
                "a,b",
                "正解。a(将来効・既提供分は弁済済み)とb(未提供分から取消料等を差し引いて払戻し)が正しい。",
            ),
            (
                "B",
                "a,c",
                "不正解。cは誤り。添乗員指示違反等による一部解除でも、未提供分から取消料等を差し引いた金額の払戻しを要する(払戻し不要ではない)。",
            ),
            (
                "C",
                "b,c",
                "不正解。cは誤り。未提供分について払戻しを要しないとする点が誤りである。",
            ),
            (
                "D",
                "a,b,c",
                "不正解。cは誤り。未提供分の払戻しを要しないとする点が誤りである。",
            ),
        ],
        "【制度】\n旅行開始後の業者による一部解除。\n"
        ...
        "【要点】\ncの「払戻し不要」が誤り。未提供分から取消料等差引いて払戻す。\n\n"
        "【選択肢との対応】\n- ア(a,b)→ 正解\n- cを含む組は不可\n\n"
    ...
    q(
        ...
        [
            (
                "A",
                "a,b",
                "不正解。bは正しい(契約内容の理解努力義務)。誤っているのはaであり、bを含む組は誤り。",
            ),
            (
                "B",
                "a,c",
                "正解。aは旅行代金限度の賠償としており誤り(限度なく賠償)。cは申出時期が誤りで、旅行地において速やかに申し出る(旅行終了後ではない)。",
            ),
            (
                "C",
                "b,c",
                "不正解。bは正しい。誤っているcを含むが、正しいbとの組合せは「誤っているもののみ」の答えにならない。",
            ),
            (
                "D",
                "a,b,c",
                "不正解。bは正しいため、誤っているもののみの組ではない。",
            ),
        ],
        "【制度】\n旅行者の責任。\n"
    ...
    q(
        ...
        [
            (
                "A",
                "a,d",
                "正解。a(終了日翌日起算30日以内の支払)とd(航空会社の変更で変更補償金要)が正しい。",
            ),
            (
                "B",
                "b,c",
                "不正解。bは安全確保措置による変更で変更補償金は免責。cは変更補償金と損害賠償金の二重払いではなく、損害賠償金から既払の変更補償金を差し引く(相殺)。",
            ),
            (
                "C",
                "b,c,d",
                "不正解。b(安全確保措置は免責)とc(二重払いではなく相殺)が誤り。",
            ),
            (
                "D",
                "a,b,c,d",
    ...
    q(
        ...
        [
            (
                "A",
                "a,b",
                "正解。aは賠償責任の有無を問わず特別補償を支払う制度であり誤り。bは解散後であり企画旅行参加中ではないため入院見舞金の対象外。",
            ),
            (
                "B",
                "c,d",
                "不正解。c(国内死亡各1,500万円)とd(181日目診断による後遺障害認定)はいずれも正しい。",
            ),
            (
                "C",
                "a,b,c",
                "不正解。cは正しい。誤っているのはaとbのみ。",
            ),
            (
                "D",
                "a,b,c,d",
        ...
        "【要点】\n誤っているのはa(責任ある場合に限る)とb(解散後)→ ア(a,b)。\n\n"
        "【選択肢との対応】\n- ア(A)が正解\n- c・dを含む「誤りのみ」の組は不可\n\n"
    ...
    q(
        ...
        [
            (
                "A",
                "a,b",
                "不正解。a(契約責任者の代理権みなし)もb(名簿・人数の提出・通知)も正しいが、正しいものすべてを選ぶ問におけるこの組合せとしては不十分である。",
            ),
            (
                "B",
                "a,c",
                "不正解。a(契約責任者の代理権みなし)もc(構成者に対する責任者の債務への非関与)も正しいが、正しいものすべてを選ぶ問におけるこの組合せとしては不十分である。",
            ),
            (
                "C",
                "b,c",
                "不正解。b(名簿・人数の提出・通知)もc(構成者に対する責任者の債務への非関与)も正しいが、正しいものすべてを選ぶ問におけるこの組合せとしては不十分である。",
            ),
            (
                "D",
                "a,b,c",
                "正解。a(契約責任者の代理権みなし)、b(名簿・人数の提出・通知)、c(構成者に対する責任者の債務への非関与)はいずれも正しい。",
            ),
        ],
        "【制度】\n手配旅行の団体・グループ手配。\n"
